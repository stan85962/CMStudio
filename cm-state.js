...
const TEMPLATES = {
  intelixa: {
    tiktok: [
      {id:1,  text:"IA qui remplace une tâche bureau"},
      {id:2,  text:"Excel automatisé en 30 secondes"},
      {id:3,  text:"Formation CPF depuis son canapé"},
      {id:4,  text:"Un dirigeant qui gagne 2h par jour"},
      {id:5,  text:"POV : tu découvres l'automatisation"},
      {id:6,  text:"3 choses que l'IA fait mieux que toi"},
      {id:7,  text:"Coulisses : ma compta gérée par l'IA"},
      {id:8,  text:"Tu connais ton score de productivité ?"},
      {id:9,  text:"47% des tâches admin sont automatisables"},
      {id:10, text:"J'ai perdu 3h par semaine pendant 2 ans"},
      {id:11, text:"L'IA va-t-elle remplacer ton assistante ?"},
      {id:12, text:"Témoignage dirigeant TPE après 6 mois d'IA"},
      {id:13, text:"Avant/après : bureau sans IA vs avec IA"},
      {id:14, text:"Test gratuit : mesure ton retard digital"},
      {id:15, text:"Comment fonctionne ChatGPT pour les nuls"}
    ],
    linkedin: [
      {id:1,  text:"Pourquoi les TPE ignorent encore l'IA"},
      {id:2,  text:"3 outils IA gratuits pour indépendants"},
      {id:3,  text:"Excel vs automatisation en 2026"},
      {id:4,  text:"Ce que ChatGPT ne fera jamais à ta place"},
      {id:5,  text:"Les dirigeants perdent 6h/semaine en tâches auto"},
      {id:6,  text:"De Excel manuel à flux automatisé en 48h"},
      {id:7,  text:"La formation CPF est-elle utile en 2026 ?"},
      {id:8,  text:"Quel est ton plus gros frein à la digitalisation ?"},
      {id:9,  text:"POV dirigeant : 1 an après l'IA en entreprise"},
      {id:10, text:"12 TPE formées, 0 regret"},
      {id:11, text:"IA générative vs automatisation : la différence"},
      {id:12, text:"Diagnostic gratuit productivité TPE"},
      {id:13, text:"Former une équipe entière en 2 jours"},
      {id:14, text:"ROI formation bureautique en 3 mois"},
      {id:15, text:"Pourquoi l'IA commence toujours par Excel"}
    ],
    instagram: [
      {id:1,  text:"Avant/après automatisation bureau"},
      {id:2,  text:"Routine matinale entrepreneur digitalisé"},
      {id:3,  text:"Formation CPF : investissement ou gadget ?"},
      {id:4,  text:"IA et comptabilité : mythe ou réalité"},
      {id:5,  text:"5 tâches à automatiser cette semaine"},
      {id:6,  text:"J'ai doublé ma productivité sans coder"},
      {id:7,  text:"Combien tu perds en tâches manuelles ?"},
      {id:8,  text:"Coulisses : nos formations en action"},
      {id:9,  text:"2h gagnées par jour dès le 1er mois"},
      {id:10, text:"Avant/après d'un client Intelixa"},
      {id:11, text:"POV : ta journée idéale avec l'IA"},
      {id:12, text:"Formation Excel dispo CPF cette semaine"},
      {id:13, text:"Prompt ChatGPT pour rédiger tes emails"},
      {id:14, text:"Tout automatiser, est-ce risqué ?"},
      {id:15, text:"Moi avant vs après la formation IA"}
    ],
    gmb: [
      {id:1,  text:"Formation Excel pour TPE"},
      {id:2,  text:"Automatisation comptabilité micro-entreprise"},
      {id:3,  text:"IA pour gagner du temps en gestion"},
      {id:4,  text:"Digitalisation TPE sans budget IT"},
      {id:5,  text:"Formation Word finançable CPF"},
      {id:6,  text:"Productivité dirigeant : cas pratique"},
      {id:7,  text:"IA appliquée aux RH pour TPE"},
      {id:8,  text:"Automatisation devis et facturation"},
      {id:9,  text:"Formation PowerPoint pour indépendants"},
      {id:10, text:"Pilotage entreprise avec Excel avancé"},
      {id:11, text:"IA et gestion commerciale TPE"},
      {id:12, text:"Formation bureautique sur mesure"},
      {id:13, text:"ChatGPT en entreprise : guide pratique"},
      {id:14, text:"Excel pour la compta des micro-entreprises"},
      {id:15, text:"Formation CPF 2026 : ce qui change"}
    ],
    facebook: [
      {id:1,  text:"Vous utilisez l'IA au bureau ?"},
      {id:2,  text:"Témoignage dirigeant TPE et automatisation"},
      {id:3,  text:"Astuce Excel qui change tout"},
      {id:4,  text:"Formation bureautique finançable CPF"},
      {id:5,  text:"Sondage : quel outil IA utilisez-vous ?"},
      {id:6,  text:"1 astuce IA par semaine"},
      {id:7,  text:"Comment j'ai sauvé 3h par semaine"},
      {id:8,  text:"Votre plus grande perte de temps en gestion ?"},
      {id:9,  text:"Formation CPF : guide pas à pas"},
      {id:10, text:"Avant/après digitalisation client"},
      {id:11, text:"L'IA remplace-t-elle le comptable ?"},
      {id:12, text:"Les 5 bases d'Excel indispensables"},
      {id:13, text:"Une journée de formation chez Intelixa"},
      {id:14, text:"80% des TPE sans formation IA"},
      {id:15, text:"Avis client après formation Excel"}
    ],
    pinterest: [
      {id:1,  text:"Infographie automatisation TPE"},
      {id:2,  text:"Checklist formation IA entrepreneur"},
      {id:3,  text:"Guide digitalisation PME 2026"},
      {id:4,  text:"Schéma productivité dirigeant"},
      {id:5,  text:"10 tâches automatisables avec l'IA"},
      {id:6,  text:"Guide Excel avancé pour indépendants"},
      {id:7,  text:"Mindmap : IA en entreprise pour débutants"},
      {id:8,  text:"Checklist CPF : financer sa formation"},
      {id:9,  text:"Schéma workflow automatisé TPE"},
      {id:10, text:"ROI formation bureautique en infographie"},
      {id:11, text:"Guide ChatGPT appliqué aux métiers admin"},
      {id:12, text:"Checklist digitalisation annuelle TPE"},
      {id:13, text:"De l'idée à l'automatisation en 5 étapes"},
      {id:14, text:"Comparatif outils IA gratuits vs payants"},
      {id:15, text:"Excel macros pour non-développeurs"}
    ],
    spotify: [
      {id:1,  text:"IA pour les nuls en entreprise"},
      {id:2,  text:"Témoignage : 10h gagnées par semaine"},
      {id:3,  text:"Formation CPF : par où commencer ?"},
      {id:4,  text:"Automatisation sans coder : c'est possible"},
      {id:5,  text:"Interview : un dirigeant qui a tout automatisé"},
      {id:6,  text:"Les erreurs à éviter avec l'IA"},
      {id:7,  text:"L'IA va-t-elle remplacer les formateurs ?"},
      {id:8,  text:"Excel en 2026 : toujours utile ?"},
      {id:9,  text:"Coulisses : comment on conçoit nos formations"},
      {id:10, text:"Un freelance qui gagne 2h/jour avec l'IA"},
      {id:11, text:"Digitalisation d'urgence pour TPE"},
      {id:12, text:"J'ai failli fermer sans l'IA"},
      {id:13, text:"Les outils IA qu'on garde pour nous"},
      {id:14, text:"Formation en ligne vs présentiel en 2026"},
      {id:15, text:"Un comptable qui utilise ChatGPT"}
    ],
    brevo: [
      {id:1,  text:"Newsletter : outils IA du mois"},
      {id:2,  text:"Email : nouvelle formation disponible"},
      {id:3,  text:"Campagne : CPF avant fin d'année"},
      {id:4,  text:"Recap : astuces productivité semaine"},
      {id:5,  text:"Êtes-vous prêt pour l'IA en entreprise ?"},
      {id:6,  text:"Newsletter : retour terrain formation Excel"},
      {id:7,  text:"Offre formation duo dirigeant / assistante"},
      {id:8,  text:"Email : checklist productivité offerte"},
      {id:9,  text:"Réactivation : 3 mois sans formation"},
      {id:10, text:"Newsletter : nouveauté IA du trimestre"},
      {id:11, text:"Email bienvenue : votre parcours Intelixa"},
      {id:12, text:"Formation IA offerte à 2 inscrits simultanés"},
      {id:13, text:"Découvrez nos flux CPF automatisés"},
      {id:14, text:"Newsletter : cas client du mois"},
      {id:15, text:"Email post-formation : votre prochaine étape"}
    ],
    youtube: [
      {id:1,  text:"Tuto : automatiser Excel en 10 min"},
      {id:2,  text:"IA vs humain : lequel est plus productif ?"},
      {id:3,  text:"Formation CPF mode d'emploi 2026"},
      {id:4,  text:"Ce que les TPE ratent avec l'IA"},
      {id:5,  text:"Créer un tableau de bord automatique Excel"},
      {id:6,  text:"Dirigeant TPE 6 mois après sa formation IA"},
      {id:7,  text:"ChatGPT vs Copilot pour les pros"},
      {id:8,  text:"Live Q&A : formations CPF, on répond à tout"},
      {id:9,  text:"L'IA va-t-elle supprimer des postes admin ?"},
      {id:10, text:"Automatiser ses emails avec l'IA"},
      {id:11, text:"Digitalisation d'une TPE en 30 jours"},
      {id:12, text:"Excel pour débutants absolus"},
      {id:13, text:"Un RH qui utilise l'IA au quotidien"},
      {id:14, text:"1 semaine avec un dirigeant digitalisé"},
      {id:15, text:"Créer un prompt ChatGPT pour son activité"}
    ]
  },
  doudelio: {
    tiktok: [
